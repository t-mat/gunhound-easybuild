enum {
 enTexPageBase = enTexCEneH0402BloodSocker,
};
gxSprite SprCEneH0402BloodSocker[]={
...
Sint32 sPosCEneH0402BloodSocker[][16]={
    {160,200,0,0,0,0,100,100,100,0},//シーン
    {-5,-33,0,0,0,0,100,100,100,1},//胴体
...
Sint32 m_sParentCEneH0402BloodSocker[]={
    -1,
    enPARENT,
    enDOUTAI,
    enDOUTAI,
