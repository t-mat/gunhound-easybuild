enum {
 enTexPageBase = enTexCEneH0005TransHeli,
};
gxSprite SprCEneH0005TransHeli[]={
    {enTexPageBase+0,0,0,1,1,0,0},//ダミー
    {enTexPageBase+0,0,0,132,48,64,24},//胴体
...
Sint32 sPosCEneH0005TransHeli[][16]={
    ...
    {-13,10,-1,0,0,0,100,100,100,9},//ミサイルポッド
...
Sint32 m_sParentCEneH0005TransHeli[]={
    -1,
    enPARENT,
    enDOUTAI,
    enDOUTAI,
